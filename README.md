...
We designed this tool to combine the strenghts of both previous tools in order to detect as many secrets as possible, and to have an efficient classification of these secrets.
